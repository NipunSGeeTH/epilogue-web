...
export default function Experience() {
  ...
  return (
    <section className="pt-4 sm:pt-6 pb-16 sm:pb-20 px-4 md:px-gutter reveal" id="experience">
      <div className="max-w-container-max mx-auto">
        <h2 className="font-display-lg text-3xl sm:text-5xl lg:text-display-lg mb-6 sm:mb-8 text-center text-gray-900/10 dark:text-on-surface/10 uppercase tracking-widest font-extrabold relative">
          WHAT IS EPILOGUE
