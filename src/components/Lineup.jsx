        ...
        {(progress) => {
          ...
          return (
            <section className="relative min-h-screen flex flex-col justify-center px-4 md:px-gutter overflow-hidden w-full max-w-container-max mx-auto">
              <h2 
                className="font-display-lg text-4xl sm:text-6xl lg:text-display-lg mb-12 text-center text-gray-900/10 dark:text-on-surface/10 uppercase tracking-widest font-extrabold relative"
                style={{
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                {/* Band Card */}
                <div 
                  className="relative group overflow-hidden rounded-2xl glass-panel border-glow shadow-2xl aspect-[16/10] lg:aspect-[4/3] w-full"
                  style={{
                    opacity: cardOpacity,
                    transform: `translateX(${Math.min(0, cardX)}px)`,
                    willChange: 'transform, opacity'
                  }}
                >
                  <img 
                ...
                <div 
                  ...
                  style={{
                    opacity: infoOpacity,
                    transform: `translateX(${Math.max(0, infoX)}px)`,
                    willChange: 'transform, opacity'
                  }}
                >
          ...
          return (
            <section className="relative min-h-screen flex flex-col justify-center px-4 md:px-gutter overflow-hidden w-full max-w-container-max mx-auto border-t border-outline-variant/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto w-full">
                {/* Artist 1 Card */}
                <div 
                  className="glass-panel p-8 sm:p-10 rounded-3xl border border-green-500/20 shadow-[0_8px_32px_rgba(34,255,68,0.05)] flex flex-col bg-[#121414]/60 relative overflow-hidden backdrop-blur-xl"
                  style={{
                    opacity: card1Opacity,
                    transform: `translateY(${Math.max(0, card1Y)}px)`,
                    willChange: 'transform, opacity'
                  }}
                >
                ...
                {/* Artist 2 Card */}
                <div 
                  className="glass-panel p-8 sm:p-10 rounded-3xl border border-cyan-500/20 shadow-[0_8px_32px_rgba(6,182,212,0.05)] flex flex-col bg-[#121414]/60 relative overflow-hidden backdrop-blur-xl"
                  style={{
                    opacity: card2Opacity,
                    transform: `translateY(${Math.max(0, card2Y)}px)`,
                    willChange: 'transform, opacity'
                  }}
                >
