...
export default function Gallery({ galleryImages, openLightbox }) {
  ...
  return (
    <section className="pt-4 sm:pt-6 pb-16 sm:pb-20 px-4 md:px-gutter reveal bg-surface-container-lowest" id="gallery">
      <div className="max-w-container-max mx-auto relative px-4">
        <h2 className="font-display-lg text-4xl sm:text-6xl lg:text-display-lg mb-6 sm:mb-8 text-center text-gray-900/10 dark:text-on-surface/10 uppercase tracking-widest font-extrabold relative">
          THE GALLERY
